...
describe("manifestToTools", () => {
  ...
  it("navigate tool has screen enum from manifest", () => {
    ...
    expect(params.properties.screen.enum).toEqual([
      "dashboard",
      "contacts",
      "deals",
      "settings",
  ...
  it("fill_field has animate enum", () => {
    ...
    expect(params.properties.animate.enum).toEqual([
      "typewriter",
      "count_up",
      "fade_in",
      "none",
  ...
  it("show_toast has level enum", () => {
    ...
    expect(params.properties.level.enum).toEqual([
      "info",
      "success",
      "warning",
      "error",
...
describe("toolCallToUIAction", () => {
  ...
  it("converts click_action", () => {
    const action = toolCallToUIAction(
      "click_action",
      JSON.stringify({ action: "create_deal" }),
    );
  ...
  it("converts ask_confirm", () => {
    const action = toolCallToUIAction(
      "ask_confirm",
      JSON.stringify({ message: "Are you sure?" }),
    );
